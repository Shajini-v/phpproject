		...
		<div class="form-body">
			<form action="updateproduct.php" method="post" enctype="multipart/form-data"> 
				...
				<div class="form-group"> 
                    <label>ID :</label> 
					<!-- ...............................................................................$row['c name'] -->
                    <input type="hidden" name="id" class="form-control" placeholder="" value="<?php echo $row["id"];?>"> 
                </div>
                <div class="form-group"> 
                    <label>Name :</label> 
                    <input type="name" name="c_name" class="form-control" placeholder="name" value="<?php echo $row["name"];?>"> 
                </div>
				<div class="form-group"> 
                    <label>size :</label> 
                    <input type="name" name="c_size" class="form-control" placeholder="name" value="<?php echo $row["size"];?>"> 
                </div>
				<div class="form-group"> 
                    <label>Amount :</label> 
                    <input type="name" name="c_amount" class="form-control" placeholder="name" value="<?php echo $row["amount"];?>"> 
                </div>
				<div class="form-group"> 
                    <label>Offer :</label> 
                    <input type="name" name="c_offer" class="form-control" placeholder="name" value="<?php echo $row["offer"];?>"> 
                </div>
			
				<div class="form-group">
					<label>Select a Category</label>
					<select style="width:150px;" name="c_category">
						<?php
							require("connection.php");
                ...
                <div class="form-group"> 
                    ...
                    <input type="file" name="c_image" id="exampleInputFile" value="<?php echo $row["image"]; ?>" >
                </div> 
