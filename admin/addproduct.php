		...
		<div class="form-body">
			<form action="addproduct_action.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group"> 
                    <label>Name :</label> 
                    <input type="name" name="c_name" class="form-control" placeholder="Name..."> 
                </div>
				<div class="form-group"> 
                    <label>Size :</label> 
                    <input type="text" name="c_size" class="form-control" placeholder="Size..."> 
                </div> 
				<div class="form-group"> 
                    <label>Amount : </label> 
                    <input type="text" name="c_amount" class="form-control" placeholder="Amount..."> 
                </div>  
				<div class="form-group"> 
                    <label>Offers : </label> 
                    <input type="text" name="c_offer" class="form-control" placeholder="Offers..."> 
                </div> 	
                ...
                <div class="form-group"> 
                    ...
                    <input type="file" name="c_image" id="exampleInputFile" >
                </div> 
