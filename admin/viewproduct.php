...
<div class="graph">
	<div class="tables">
			...
			// $result = $con ->query("SELECT  * from product LEFT JOIN category on product.category = category.category_id");
			$result = $con->query("SELECT product.id, product.name, product.size, product.amount, product.offer, product.image, category.category_name FROM product 
                        JOIN category ON product.category = category.category_id");
		...
		<table class="table table-bordered">
			...
			<a href="addproduct.php">add product</a> 
				<h1 style="text-align:center;">View Product Details</h1>
			<tr>
                <th colspan="5" style="text-align:center;"><a href="excelfile.php">EXPORT TO EXCEL</a></th><br>
			...
			<tr>
				...
				<td><img style="width:100px; height:100px;" src="<?php echo "imageproduct/".$row["image"]; ?>"></td>
				<!-- ....................................................................dell =variable passed to delete page -->
				<td><a onclick="return confirm('Are you sure?')" href="deleteproduct.php?dell=<?php echo $row["id"];?>"> Delete</a></td>
				 <!-- .......................varr =variable passed to edit page -->
				<td><a href="editproduct.php?varr=<?php echo $row["id"]; ?>">Edit</a></td>
			</tr>
			</tbody>
				<?php
					}
