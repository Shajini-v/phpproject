...
<div class="tables">
			...
			$result = $con ->query("SELECT * from register JOIN `states` ON register.state = states.stat_id JOIN countries ON states.country_id =countries.cont_id");
			$count  = $result -> num_rows;
			?>
		<table class="table table-bordered">
			<thead>
				<h1 style="text-align:center;">View Register Details</h1>
			<tr>
                <th colspan="6" style="text-align:center;"><a href="excelfile.php">EXPORT TO EXCEL</a></th><br>
				<th colspan="5" style="text-align:center;"><a href="productpdffile.php">EXPORT TO PDF</a></th>
			...
			<tr>
				...
				<!-- ....................................................................dell =variable passed to delete page -->
				<td><a onclick="return confirm('Are you sure?')" href="deleteregister.php?dell=<?php echo $row["id"];?>"> Delete</a></td>
				<td><a href="editregister.php?varr=<?php echo $row["id"]; ?>">Edit</a></td>
				 <!-- .......................varr =variable passed to edit page -->
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="main.php"><span class=" name-caret"> <?php echo  $_SESSION["username"];  ?> </span></a>
