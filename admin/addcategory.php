...
<div class="outter-wp">
	<div class="graph-form">
		<div class="form-body">
			<form action="addcategory_action.php" method="post" enctype="multipart/form-data"> 
			<a href="viewcategory.php"> Go To View category</a>
                <div class="form-group"> 
                    <label style="text-align:center;">Eye Glass Category - Name :</label> 
                    <input style="text-align:center; width:50%;" type="name" name="eye_name" class="form-control" placeholder="....."> 
                </div>
                <div class="form-group"> 
                    <label for="exampleInputFile">File input</label> 
                    <input type="file" name="eye_image" id="exampleInputFile" >
                </div> 
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="main.php"><span class=" name-caret">XXX</span></a>
