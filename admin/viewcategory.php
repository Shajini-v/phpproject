...
<div class="graph">
	<div class="tables">
		...
		<table class="table table-bordered">
			<a href="addcategory.php"> Go To Add category</a>
			<thead>
                <tr>
                <th colspan="3" style="text-align:center;"><a href="excelfile.php">EXPORT TO EXCEL</a></th><br>
				<th colspan="3" style="text-align:center;"><a href="categorypdffile.php">EXPORT TO PDF</a></th>
                </tr>
					<tr>
                    <th>s.no</th>
					<th>Id</th>
			...
			<tr>
				...
				<td><img style="width:100px; height:100px;" src="<?php echo "imagecategory/".$row["image"]; ?>"></td>
				<!-- .....................................................................del =variable passed to delete page -->
				<td><a onclick="return confirm('Are you sure?')" href="categorydelete.php?del=<?php echo $row["category_id"]; ?>"> Delete</a></td>
				 <!-- ................var =variable passed to edit page -->
				<td><a href="editcategory.php?var=<?php echo $row["category_id"]; ?>">Edit</a></td>
			</tr>
			</tbody>
				<?php
					}
