						...
						<div class="wrap">
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="#" method="post">
									...
									<button type="submit" class="btn btn-primary submit mb-4">Sign In</button><br>
									<p style="color:blue;">Don't have a account?</p><a href="register.php">register now !</a>
								</form>
							</div>
						</div>
					</div>
...
<!-- category view------------------------------------------------------------------------------------------------------ -->
<h1 style="margin:50px;font-weight:bold;">Category View </h1> 
					...
					<?php
						...
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
								<img style="width:360px; height:300px;border:1px solid black;" src="<?php echo "admin/imagecategory/".$row["image"]; ?>">
								</div>
								<div class="team-info">
...
<!-- product view------------------------------------------------------------------------------------------------------ -->
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		...
		<h1 style="margin:50px;font-weight:bold;">Product View </h1> 
				...
				<div class="row">
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item" style="margin:10px;">
								<div class="men-thumb-item">
								<img style="width:300px; height:300px;" src="<?php echo "admin/imageproduct/".$row["image"]; ?>">
									<div class="men-cart-pro"><div class="inner-men-cart-pro"><a href="single.html" class="link-product-add-cart">Quick View</a></div></div>
									<span class="product-new-top">New</span>
								</div>
								<div class="item-info-product">
									<div class="info-product-price">
										<div class="grid_meta">
											<div class="product_price"><h4><a href="single.html"><?php echo $row["name"]; ?></a></h4>
												<div class="grid-price mt-2"><span class="money "><?php echo $row["size"]; ?> <?php echo $row["amount"]; ?></span></div>
												<div class="grid-price mt-2"><span class="money "><?php echo $row["offer"]; ?></span></div>
											</div>
											<ul class="stars">
